<?php
/**
 * Toolbar API: WP_Admin_Bar_mat class
 *
 * @package WordPress
 * @subpackage Toolbar
 * @since 3.1.0
...
class WP_Admin_Bar{
	...
	public function __get( $name ) {
		switch ( $name ) {
			...
			case 'menu' :
				_deprecated_argument( 'WP_Admin_Bar_mat', '3.3.0', 'Modify admin bar nodes with WP_Admin_Bar_mat::get_node(), WP_Admin_Bar_mat::add_node(), and WP_Admin_Bar_mat::remove_node(), not the <code>menu</code> property.' );
	...
	public function initialize() {
		...
		/**
		 * Fires after WP_Admin_Bar_mat is initialized.
		 *
		 * @since 3.1.0
		 */
	 ...
	 *
	 * @since 3.1.0
	 * @deprecated 3.3.0 Use WP_Admin_Bar_mat::_render_item() or WP_Admin_bar::render() instead.
	 * @see WP_Admin_Bar_mat::_render_item()
	 * @see WP_Admin_Bar_mat::render()
	 *
	 * @param string $id    Unused.
	 * @param object $node
	 */
	public function recursive_render( $id, $node ) {
		_deprecated_function( __METHOD__, '3.3.0', 'WP_Admin_bar::render(), WP_Admin_Bar_mat::_render_item()' );
